import fs from 'fs';
import type { ResponseLike } from 'nineteen58-agents/internal/to-file';
import { toFile } from 'nineteen58-agents/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('nineteen58-agents/core/uploads');
    await expect(
